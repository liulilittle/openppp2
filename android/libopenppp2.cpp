...
// package: supersocksr.ppp.android.c
// public final class libopenpppp2 
// public native bool set_dns_bcl(int ttl, string dns)
__LIBOPENPPP2__(jboolean) Java_supersocksr_ppp_android_c_libopenppp2_set_1dns_1bcl(JNIEnv* env, jobject* this_, jint ttl, jstring dns) noexcept {
    __LIBOPENPPP2_MAIN__;
