...
#if defined(_LINUX)
            ethernet->AddLoadIPList(network_interface->BypassIplist, network_interface->BypassIplistNic, network_interface->BypassIplistNgw);
#else
            ethernet->AddLoadIPList(network_interface->BypassIplist, network_interface->BypassIplistNgw);
#endif
...
#if defined(_LINUX)
                ethernet->AddLoadIPList(path, route.nic, Ipep::ToAddress(route.ngw));
#else
                ethernet->AddLoadIPList(path, Ipep::ToAddress(route.ngw));
#endif
            }
