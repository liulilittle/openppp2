...
namespace ppp {
    namespace net {
        namespace native {
            ...
            inline unsigned long long htonll(unsigned long long n) noexcept {
                return ((uint64_t)htonl((uint32_t)(n >> 32))) | ((uint64_t)htonl((uint32_t)n) << 32);
            }

            inline unsigned long long ntohll(unsigned long long n) noexcept {
                return htonll(n);
            }
