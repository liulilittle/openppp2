    ...
    namespace net {
        ...
        bool Ipep::IsDomainAddress(const ppp::string& domain) noexcept {
            ...
            if (address_string == "localhost") {
                ...
                boost::asio::ip::address address = boost::asio::ip::address::from_string(address_string.data(), ec);
        ...
        bool Ipep::SetDnsAddresses(const ppp::vector<ppp::string>& addresses) noexcept {
            return ppp::tap::TapLinux::SetDnsAddresses(addresses);
        }
#endif
        ...
        static int StringToCidrNumber(const ppp::string& cidr_number_string) noexcept {
            ...
            boost::system::error_code ec;
            boost::asio::ip::address address = boost::asio::ip::address::from_string(cidr_number_string.data(), ec);
            if (ec) {
                return ERR_PREFIX_VALUE;
            }
        ...
        bool Ipep::ParseCidr(const ppp::string& cidr_ip_string, boost::asio::ip::address& destination, int& cidr) noexcept {
            ...
            int cidr_number = StringToCidrNumber(cidr_ip_string.substr(index + 1));
            if (cidr_number < ppp::net::native::MIN_PREFIX_VALUE) {
                return false;
            }

            if (cidr_number > ppp::net::native::MAX_PREFIX_VALUE) {
                return false;
            }
