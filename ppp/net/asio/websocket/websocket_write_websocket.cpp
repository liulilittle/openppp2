    ...
    namespace net {
        namespace asio {
            bool websocket::Write(const void* buffer, int offset, int length, const AsynchronousWriteCallback& cb) noexcept {
                ...
                auto complete_do_write_async_callback = [self, this, cb, buffer, offset, length, context = context_, strand = strand_]() noexcept {
                ...
                return ppp::threading::Executors::Post(context_, strand_, complete_do_write_async_callback);
            }
        }
    }
}