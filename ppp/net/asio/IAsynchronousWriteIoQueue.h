...
namespace ppp {
    namespace net {
        namespace asio {
            ...
            private:
                ...
                public:
                    void                                                operator()(bool b) noexcept {
                        AsynchronousWriteBytesCallback f = this->Move();
                        if (f) {
                            f(b);
                        }
                    }
            ...
            private:
                bool                                                    DoWriteBytesUnsafe(const AsynchronousWriteIoContextPtr& context) noexcept;
                int                                                     DoWriteNext(bool nexting) noexcept;
