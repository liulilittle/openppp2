...
namespace ppp {
    namespace cryptography {
        static struct OPENSSL_LIBRARY_INITIALIZE {
            OPENSSL_LIBRARY_INITIALIZE() noexcept {
                /* initialize OpenSSL */
...
#pragma GCC diagnostic pop
        ...
        void EVP::initCipher(std::shared_ptr<EVP_CIPHER_CTX>& context, int enc) {
        ...
        void EVP::initKey(const ppp::string& method, const ppp::string password) {
