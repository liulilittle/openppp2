...
static constexpr int         PPP_DEFAULT_TCP_TIMEOUT      = 300;
static constexpr int         PPP_DEFAULT_UDP_TIMEOUT      = 72;    /* PPP_DEFAULT_UDP_TIMEOUT */
static constexpr int         PPP_DNS_DEFAULT_PORT         = 53;
