...
namespace ppp {
    namespace transmissions {
        ...
        bool ITcpipTransmission::DoWriteBytes(std::shared_ptr<Byte> packet, int offset, int packet_length, const std::shared_ptr<AsynchronousWriteBytesCallback>& cb) noexcept {
            ...
            auto complete_do_write_bytes_async_callback = [self, this, packet, offset, packet_length, fcb]() noexcept {
            ...
            boost::asio::dispatch(socket_->get_executor(), complete_do_write_bytes_async_callback);
            return true;
        }
    }
}