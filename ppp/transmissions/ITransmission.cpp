...
#pragma GCC optimize("O0")
            ...
            static bool                                 Write(ITransmission* transmission, YieldContext& y, const void* packet, int packet_length) noexcept {
                ...
                if (NULL != co) {
                    return ITransmission::DoWriteYield<AsynchronousWriteCallback>(*co, packet, packet_length,
                    ...
                    return ITransmissionBridge::Write(transmission, packet, packet_length, fx);
                }
            }
#if _WIN32
#pragma optimize("", on)
