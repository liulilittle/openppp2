...
namespace ppp {
    ...
    public:
        ...
        DateTime(long long ticks) noexcept {
            m_ticks = ticks;
        };
    ...
    public:
        DateTime         AddTicks(long long value) noexcept {
    ...
    private:
        long             DateToTicks(int year, int month, int day) noexcept {
