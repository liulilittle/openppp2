    ...
    namespace app {
        namespace client {
            ...
            public:
                ...
                std::shared_ptr<Byte>                                                   GetBuffer() noexcept;
            ...
            protected:
                virtual std::shared_ptr<boost::asio::ip::tcp::socket>                   NewAsynchronousSocket(const ContextPtr& context, const boost::asio::ip::tcp& protocol, ppp::coroutines::YieldContext& y) noexcept;
            ...
            private:
                ...
                inline                                                                  NewWebsocketTransmission(const ContextPtr& context, const std::shared_ptr<boost::asio::ip::tcp::socket>& socket, const ppp::string& host, const ppp::string& path) noexcept {
            ...
            private:
                ...
                bool                                                                    Sleep(int timeout, const ContextPtr& context, YieldContext& y) noexcept;
#if defined(_ANDROID)
                bool                                                                    AwaitJniAttachThread(const ContextPtr& context, YieldContext& y) noexcept;
#endif

            private:
                class StaticEchoDatagarmSocket : public boost::asio::ip::udp::socket {
                public:
                ...
                boost::asio::ip::udp::endpoint                                          StaticEchoRemoteEndPoint(boost::asio::ip::udp::endpoint* remoteEP) noexcept;
            ...
            private:
                ...
                std::shared_ptr<boost::asio::deadline_timer>                            sleep_timer_;
                struct {
                ...
                boost::asio::ip::udp::endpoint                                          static_echo_server_ep_;
                boost::asio::ip::udp::endpoint                                          static_echo_exchanger_ep_;
