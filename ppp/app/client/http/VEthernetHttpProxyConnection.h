        ...
        namespace client {
            ...
            namespace http {
                ...
                public:
                    ...
                    VEthernetHttpProxySwitcherPtr                                       GetProxy()           noexcept { return proxy_; }
                    ...
                    std::shared_ptr<VEthernetHttpProxyConnection>                       GetReference()       noexcept { return shared_from_this(); }
