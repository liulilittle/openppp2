...
namespace ppp {
    namespace app {
        namespace protocol {
            ...
            public:
                bool                                                            MPEntry(Int128 guid, const boost::asio::ip::tcp::endpoint& srcEP, const boost::asio::ip::tcp::endpoint& publicEP, bool protocol_tcp_or_udp) noexcept;
                bool                                                            MPConnect(Int128 guid, const boost::asio::ip::tcp::endpoint& srcEP, const boost::asio::ip::tcp::endpoint& publicEP, const boost::asio::ip::tcp::endpoint& remoteEP) noexcept;
