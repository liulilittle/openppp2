...
namespace ppp {
    namespace app {
        namespace protocol {
            ...
            bool VirtualEthernetTcpipConnection::Accept(YieldContext& y, ITransmissionPtr& transmission) noexcept {
                typedef VirtualEthernetLinklayer::ERROR_CODES ERROR_CODES;
            ...
            bool VirtualEthernetTcpipConnection::ForwardSocketToTransmission(std::shared_ptr<Byte> buffer, int buffer_size, int bytes_transferred) noexcept {
            ...
            bool VirtualEthernetTcpipConnection::ReceiveSocketToTransmission(std::shared_ptr<Byte> buffer, int buffer_size) noexcept {
