    ...
    namespace app {
        namespace protocol {
            ...
            protected:
                ...
                virtual bool                                                OnStatic(const ITransmissionPtr& transmission, YieldContext& y) noexcept;
                virtual bool                                                OnStatic(const ITransmissionPtr& transmission, int session_id, int remote_port, YieldContext& y) noexcept;
