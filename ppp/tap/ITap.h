...
namespace ppp
{
    namespace tap
    {
        ...
        public:
            ...
            typedef ppp::function<void(ITap*, PacketInputEventArgs&)>       PacketInputEventHandler;
        ...
        public:
            ...
            bool                                                            Output(const void* packet, int packet_size) noexcept;
        ...
        public:
            static std::shared_ptr<ITap>                                    From(const std::shared_ptr<boost::asio::io_context>& context, const ppp::string& id, void* tun, uint32_t address, uint32_t gw, uint32_t mask, bool hosted_network) noexcept;
