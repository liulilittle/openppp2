...
namespace ppp
{
    namespace win32
    {
        ...
        static void __cdecl Crt_InvalidParameterHandler(const wchar_t* expression, const wchar_t* function, const wchar_t* file, unsigned int line, uintptr_t pReserved) noexcept
        {
        ...
        static void __cdecl Crt_HandlePureVirtualCall() noexcept
        {
        ...
        void* Win32Native::GetProcAddress(const char* moduleName, const char* functionName) noexcept
        {
            ...
            {
                SynchronizedObjectScope scope(SYNCHRONIZED_OBJECT_LOCK);
        ...
        void Win32Native::OptimizationSystemNetworkSettings() noexcept
        {
            SetRegistryValueDword(HKEY_LOCAL_MACHINE, LR"(SYSTEM\CurrentControlSet\Services\Tcpip\Parameters)", L"MaxUserPort", 65534);
            SetRegistryValueDword(HKEY_LOCAL_MACHINE, LR"(SYSTEM\CurrentControlSet\Services\Tcpip\Parameters)", L"TcpWindowSize", 62420);
            SetRegistryValueDword(HKEY_LOCAL_MACHINE, LR"(SYSTEM\CurrentControlSet\Services\Tcpip\Parameters)", L"TcpTimedWaitDelay", 30);
            SetRegistryValueDword(HKEY_LOCAL_MACHINE, LR"(SYSTEM\CurrentControlSet\Services\Tcpip\Parameters)", L"TcpNumConnections", 0xfffffe);
        ...
        ppp::string Win32Native::GetAllLogicalDriveStrings() noexcept
        {
            ...
            GetLogicalDriveStringsA(dw, (LPSTR)sb.get());
