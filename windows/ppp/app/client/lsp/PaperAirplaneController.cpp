        ...
        namespace client
        {
            namespace lsp
            {
                ...
                bool PaperAirplaneController::Timeout(int milliseconds, const Timer::TimeoutEventHandler& handler) noexcept
                {
                    ...
                    auto fx = make_shared_object<Timer::TimeoutEventHandler>(std::bind(&TimeoutHandler::Call, h));
                    if (NULL == fx)
                    {
                        return false;
                    }

                    std::shared_ptr<Timer> timeout = Timer::Timeout(milliseconds, fx);
                    if (NULL == timeout)
                    {
                        return false;
                    }
                ...
                {
                    auto self = shared_from_this();
                    auto fx = ppp::make_shared_object<ppp::net::Socket::AcceptLoopbackCallback>(
                    ...
                    return ppp::net::Socket::AcceptLoopbackAsync(acceptors_[0], fx);
                }
                ...
                bool PaperAirplaneController::AcceptForwardAcceptor() noexcept
                {
                    ...
                    return ppp::net::Socket::AcceptLoopbackAsync(acceptors_[1], fx);
                }
