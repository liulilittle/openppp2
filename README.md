...
| kx             | int   | 128            | Key exchange length |
| kl             | int   | 10             | Key length |
| kh             | int   | 12             | Key hash length |
| sb             | int   | 1000           | Buffer size (bytes) |
| protocol       | string | aes-128-cfb  | Protocol layer encryption algorithm |
| protocol-key   | string | N6HMzdUs7IUnYHwq | Protocol encryption key |
| transport      | string | aes-256-cfb  | Transport layer encryption algorithm |
| transport-key  | string | HWFweXu2g5RVMEpy | Transport encryption key |
| masked         | bool   | false         | Enable traffic obfuscation |
| plaintext      | bool   | false         | Allow plain text transmission |
